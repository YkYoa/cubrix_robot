...
def generate_launch_description():
    ...
    for arg in sys.argv:
        if arg.startswith("desc:="):
            ...
            if delimiter in descArg:
                ...
                package_project = descArg + "_moveit_config"
            else:
                package_version = descArg + "_moveit_config"
    ...
    # CORRECTED PACKAGE NAME: Use descArg + "_moveit_config" directly
    moveit_config_pkg = descArg + "_moveit_config"
    ...
    kinematics_yaml = loadAndMergeYaml(package_version, package_project, "config/kinematics.yaml")
