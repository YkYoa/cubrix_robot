...
class Metaclass_Joy(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ar_msgs')
        except ImportError:
            import logging
            import traceback
...
class Joy(metaclass=Metaclass_Joy):
    ...
    def __init__(self, **kwargs):
        ...
        self.button_pressed = kwargs.get('button_pressed', bool())
    ...
    def __eq__(self, other):
        ...
        if self.y != other.y:
            return False
        if self.button_pressed != other.button_pressed:
            return False
        return True
    ...
    def button_pressed(self, value):
        if __debug__:
            assert \
                ...
                "The 'button_pressed' field must be of type 'bool'"
