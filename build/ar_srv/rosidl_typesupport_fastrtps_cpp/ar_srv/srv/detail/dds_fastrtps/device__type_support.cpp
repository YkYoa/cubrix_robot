...
#include "ar_srv/srv/detail/device__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: valve_ids
  {
    cdr << ros_message.valve_ids;
  }
  // Member: valve_states
  {
    cdr << ros_message.valve_states;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: port
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.port[0]);
  ...
  // Member: valve_ids
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.valve_ids[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: valve_states
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.valve_states[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ar_srv::srv::Device_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ar_srv::srv::Device_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ar_srv::srv::Device_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Device_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ar_srv::srv::Device_Request *>(
...
static size_t _Device_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Device_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Device_Request__callbacks = {
  "ar_srv::srv",
  "Device_Request",
...
static rosidl_message_type_support_t _Device_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Device_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ar_srv
const rosidl_message_type_support_t *
get_message_type_support_handle<ar_srv::srv::Device_Request>()
{
  return &ar_srv::srv::typesupport_fastrtps_cpp::_Device_Request__handle;
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.indicator_data;
  }
  // Member: iheartdata
  {
    cdr << ros_message.iheartdata;
  }
  // Member: vacuumdata
  {
    cdr << ros_message.vacuumdata;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: indicator_data
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.indicator_data[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: iheartdata
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.iheartdata[index].size() + 1);
    }
  }
  // Member: vacuumdata
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.vacuumdata[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ar_srv::srv::Device_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ar_srv::srv::Device_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ar_srv::srv::Device_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Device_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ar_srv::srv::Device_Response *>(
...
static size_t _Device_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Device_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Device_Response__callbacks = {
  "ar_srv::srv",
  "Device_Response",
...
static rosidl_message_type_support_t _Device_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Device_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &ar_srv::srv::typesupport_fastrtps_cpp::_Device_Response__handle;
}
...
static service_type_support_callbacks_t _Device__callbacks = {
  "ar_srv::srv",
  "Device",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ar_srv, srv, Device_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ar_srv, srv, Device_Response)(),
...
static rosidl_service_type_support_t _Device__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Device__callbacks,
...
{
  return &ar_srv::srv::typesupport_fastrtps_cpp::_Device__handle;
}
