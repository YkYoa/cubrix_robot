...
static const _Joy_type_support_symbol_names_t _Joy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ar_msgs, msg, Joy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ar_msgs, msg, Joy)),
  }
};
...
{
  return &::ar_msgs::msg::rosidl_typesupport_cpp::Joy_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ar_msgs, msg, Joy)() {
  return get_message_type_support_handle<ar_msgs::msg::Joy>();
}
